...
import OurBenefits from "./Our_benefits";
          ...
          <div className="container flex flex-col lg:flex-row justify-between items-center gap-10">
            <div className="text-center lg:text-left">
              <span className="flex justify-center lg:justify-start items-center pb-[24px] gap-2">
                ...
                <p className="text-[14px] text-[#1E212C] font-bold">
                  Play showreel
                </p>
              </span>
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-4">
                <a
                  className="font-lato font-bold rounded text-[#FF3F3A] px-[32px] py-3 border-2 border-[#FF3F3A]"
                  href="/about"
                >
                  About us
                </a>
                <a
                  className="font-lato font-bold rounded text-white px-[32px] py-3 border-2 border-[#FF3F3A] bg-[#FF3F3A]"
                  href="/events"
                >
                  Explore courses
                </a>
          ...
          <div className="container mt-[80px] lg:mt-[150px] mb-[60px] flex justify-between text-center">
            {[
              ...
              <div key={i} className="flex items-center">
                <h2 className="text-[36px] sm:text-[42px] font-bold font-lato text-[#1E212C]">
                  {item.num}
                </h2>
