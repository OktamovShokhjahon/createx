    ...
    return (
      <div className="bg-[#F4F5F6] py-[120px]">
        <div className="container">
          <div className="container mb-[180px]">
            <div className="flex justify-between items-center mb-[60px]">
              ...
              <div className="flex space-x-4">
                <button
                  ref={this.prevRef}
                  className="px-4 py-2 bg-[#F4F5F6] text-[#424551] rounded-full hover:bg-[#E0E2E3]"
                >
                  ‹
                </button>
                <button
              ...
              {teamMembers.map((member, index) => (
                <SwiperSlide key={index} className="w-[285px]">
                  <div className="">
                    ...
                    />
                    <h2 className="text-center text-[20px] text-[#424551] font-bold font-lato mt-4 mb-1">
                      {member.name}
                    </h2>
                    <h3 className="text-center font-lato text-[#787A80]">
                      {member.role}
                    </h3>
                  </div>
                </SwiperSlide>
          ...
          <div className="">
            <h3 className="text-center font-lato font-bold text-[#1E212C] mb-2">
              TESTIMONIALS
            </h3>
            <h2 className="text-[46px] text-[#1E212C] font-lato font-bold text-center mb-[60px]">
                  ...
                  <SwiperSlide key={index} className="w-[1020px]">
                    <div className="max-w-[1020px] mx-auto bg-white py-[64px] px-[104px]">
                      ...
                      <span className="flex gap-[20px] items-center mt-6">
                        <img src={Av} alt="" />
                        <span>
                          <h3 className="font-bold font-lato mb-1">
                            Eleanor Pena
                          </h3>
