...
export default class OurEvents extends Component {
  render() {
    ...
    return (
      <div className="bg-[#FEDDD0] py-[80px]">
        <div className="container px-4 max-w-7xl mx-auto">
          <h3 className="text-[#1E212C] text-center uppercase mb-2 font-lato font-bold">
            Our Events
          </h3>
            ...
            {events.map((event, index) => (
              ...
              >
                <div className="flex items-center gap-6 mb-4 md:mb-0">
                  ...
                  <div>
                    <p className="text-[18px] md:text-[20px] font-bold font-lato mb-1">
                      {event.month}
                    </p>
                ...
                <div className="flex-1 mb-4 md:mb-0 px-2 md:ml-[40px]">
                  ...
                  <p className="text-[#787A80] font-lato font-bold">
                    {event.type}
                  </p>
                </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-[20px] sm:gap-[40px] justify-center">
            <p className="text-[#1E212C] text-[24px] sm:text-[28px] font-lato font-bold text-center">
              Do you want more?
            </p>
            <a
              href="/events"
              className="text-[#fff] border border-[#FF3F3A] font-lato font-bold px-6 py-3 rounded bg-transparent hover:text-white hover:bg-gradient-to-r from-[#FF3F3A] to-[#F75E05] transition duration-300 bg-[linear-gradient(56deg,_#FF3F3A_0%,_#F75E05_100%)]"
            >
              Explore all events
            </a>
          </div>
