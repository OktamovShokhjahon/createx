    ...
    return (
      <div className="container flex justify-between my-[180px] items-center">
        ...
        <div className="max-w-[390px] w-full">
          ...
          <h2 className="text-[46px] font-bold text-[#1E212C] mb-[40px] font-lato">
            Why Createx?
          </h2>
          <span className="flex flex-col gap-3">
            <p className="flex gap-4 items-start">
              <img src={Vector} alt="" />A fermentum in morbi pretium aliquam
          ...
          <a className="mt-[48px] px-[40px] inline-block font-bold rounded bg-gradient-to-r from-[#FF3F3A] to-[#F75E05] text-white leading-[44px]">
            More about us
          </a>
        </div>
      </div>
