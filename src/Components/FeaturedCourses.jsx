    ...
    return (
      <div className="container md:px-0">
        <div className="container flex flex-col md:flex-row justify-between items-start md:items-end mb-[60px] gap-4">
          <span>
            <h3 className="font-bold font-lato uppercase text-[#1E212C] mb-2">
              Ready to learn?
            </h3>
            <h2 className="text-[46px] text-[#1E212C] font-bold font-lato">
              Featured Courses
            </h2>
          </span>
          <a
        ...
        <div className="container flex flex-wrap justify-center md:justify-between gap-[30px] mb-[180px]">
          {coursesData.map((course) => (
            <div
              key={course.id}
              className="flex flex-col sm:flex-row max-w-[600px] w-full items-center sm:items-start gap-[32px] border rounded"
            >
              ...
              <div className="w-full max-w-[322px] flex flex-col justify-center h-[214px]">
                ...
                <h3 className="text-[#787A80] text-[18px]">
                  <span className="text-[#FF4242]">{course.price}</span> | by{" "}
                  {course.author}
                </h3>
              </div>
            </div>
